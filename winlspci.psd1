@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = '0.2.0 -- adds -t topology tree, -vvv, -Domain, and attribute-level serialisation (-Attribute with wildcards, -Match value filtering, -PresentOnly, -ListAttributes, -Csv) as a structured replacement for piping to grep. Fixes -s so unpadded and domain-qualified slots match.'
        }
    }
}
